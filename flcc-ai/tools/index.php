<?php
/**
 * Tools listing — auto-scans *.html in this directory (tools/)
 *
 * Each tool page should include in <head>:
 *   <meta name="date"        content="YYYY-MM-DD">
 *   <meta name="description" content="Short description">
 *   <meta name="thumbnail"   content="path/or/url/to/image.jpg">
 */
...
foreach ((array) $files as $file) {
    ...
    // Skip files without a date meta tag (e.g. empty index.html placeholders)
